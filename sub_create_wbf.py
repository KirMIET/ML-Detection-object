...
PREDS_BASE_DIR = "predictions"         # Базовая папка, где лежат папки с txt-файлами
OUTPUT_CSV = "submission_wbf.csv"      # Как назвать итоговый файл

MODEL_DIRS = [
    # "predictions/faster_rcnn_fold_1",
    # "predictions/faster_rcnn_fold_2",
...
# Веса для моделей (должно совпадать с длиной MODEL_DIRS). Если None - веса равны.
# Например: YOLO лучше, даем ей вес 2, RT-DETR вес 1 -> WEIGHTS = [2, 2, 1, 1]
MODEL_WEIGHTS = [1.1, 1.1, 1.0, 1.0]  # Настройте по своему усмотрению
