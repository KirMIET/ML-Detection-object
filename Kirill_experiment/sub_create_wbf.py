...
OUTPUT_CSV = "submission_full_wbf_softnms.csv"  # Итоговый файл

# PREDS_BASE_DIR = "predictions_tta"  

MODEL_DIRS = [
    "predictions_full_tta_sahi/yolo11m_fold_1",
    "predictions_full_tta_sahi/yolo11m_fold_2",
    "predictions_full_tta_sahi/yolo26m_fold_1",
    "predictions_full_tta_sahi/yolo26m_fold_2",
    "predictions_full_tta_sahi/rtdetr_fold_1",
    "predictions_full_tta_sahi/rtdetr_fold_2",
]
...
# Настройки WBF
IOU_THR = 0.6          # Порог пересечения (IoU) для слияния боксов
SKIP_BOX_THR = 0.01   # Игнорировать боксы с уверенностью ниже этого ДО WBF
CONF_THR_FINAL = 0.30  # Фильтр после WBF/Soft-NMS 
...
SOFT_NMS_IOU_THR = 0.45         # Порог IoU для Soft-NMS
SOFT_NMS_CONF_THR = 0.15       # Минимальная уверенность после Soft-NMS (до CONF_THR_FINAL)
