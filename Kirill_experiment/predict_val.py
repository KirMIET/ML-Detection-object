...
OUTPUT_BASE_DIR = "predictions_finetune_val"
...
MODELS = {
    ...
    "yolo11m_fold_1": {
        "type": "yolo",
        "weights": "runs/detect/runs/finetune_add_data/yolo11m_fold_1_finetuned/weights/best.pt"
    },
    "yolo11m_fold_2": {
        "type": "yolo",
        "weights": "runs/detect/runs/finetune_add_data/yolo11m_fold_2_finetuned/weights/best.pt"
    },
    
    # YOLO26m
    "yolo26m_fold_1": {
        "type": "yolo",
        "weights": "runs/detect/runs/finetune_add_data/yolo26m_fold_1_finetuned/weights/best.pt"
    },
    "yolo26m_fold_2": {
        "type": "yolo",
        "weights": "runs/detect/runs/finetune_add_data/yolo26m_fold_2_finetuned/weights/best.pt"
    },
    
    # RT-DETR 
    # "rtdetr_fold_1": {
    #     "type": "rtdetr",
    #     "weights": "runs/detect/runs/ensemble_training/rtdetr_fold_1/weights/best.pt"
    # },
    # "rtdetr_fold_2": {
    #     "type": "rtdetr",
    #     "weights": "runs/detect/runs/ensemble_training/rtdetr_fold_2/weights/best.pt"
    # },
}
